          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="social-links">
                <a href="https://github.com/abilashm" target="_blank" rel="noopener noreferrer" className="social-link">
                  <i className="fab fa-github"></i>
                </a>
                <a href="https://linkedin.com/in/abilashm" target="_blank" rel="noopener noreferrer" className="social-link">
                  <i className="fab fa-linkedin"></i>
                </a>
                <a href="mailto:abilash.m@email.com" className="social-link">
                  <i className="fas fa-envelope"></i>
                </a>
                <a href="https://twitter.com/abilashm" target="_blank" rel="noopener noreferrer" className="social-link">
